...
def main():
    ...
    # Calibrate on normal validation data with improved strategy
    print("\nCalibrating thresholds on normal data...")
    stats = detector.calibrate(val_loader, percentile=75.0, use_median=True)
    ...
    # Save results - use custom encoder for numpy types and Path objects
    results_summary = {
        'config': config,
